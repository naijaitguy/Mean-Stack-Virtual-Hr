...
this.AuthService.loginAdmin(LoginModel).subscribe(
   data => {

    this.AuthService.ReturnUrl ? this.Route.navigate([this.AuthService.ReturnUrl]) : this.Route.navigate(['/Admim/Application/Allapplications']);
